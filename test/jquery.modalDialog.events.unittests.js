...
describe("jquery.modalDialog", function()
{
    ...
    describeForDialogType("ModalDialog", { content: "#simpleDialog" });

    describeForDialogType("IFrameDialog", { url: "content/jquery.modalDialog.iframeContent.html" });

    describeForDialogType("AjaxDialog", { url: "content/jquery.modalDialog.ajaxContent.html", ajax: true });
