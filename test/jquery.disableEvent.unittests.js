describe("jquery.disableEvent plugin", function()
{
    ...
    {
        _$link = $("<a href='#'>hi</a>")
            .on("click", function() { window._linkGlobalClick = true; })
            .on("mousedown", function() { window._linkGlobalMousedown = true; })
    ...
    var basicButtonElement = function()
    {
        _$button = $("<button>button</button>")
            .on("click", function() { window._buttonGlobalClick = true; })
            .on("keydown", function() { window._buttonButtonKeydown = true; })
            .appendTo(document.body);
